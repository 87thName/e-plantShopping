                ...
                <div className="product-grid">
                    ...
                    {item.plants.map((plant)=>
                        <div className='product-card'>
                            ...
                            <p>{plant.cost}</p>
                            <button style={{ backgroundColor: alreadyInCart(plant.name) ? "#D98324" : "#3A7D44" }} disabled={alreadyInCart(plant.name)} className="product-button" onClick={() => handleAddToCart(plant)}>{alreadyInCart(plant.name) ? "Added" : "Add to Cart"}</button>
                        </div> 
                    )}      
                    </div>
                    </div>
